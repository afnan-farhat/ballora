  ...
  return (
    <section className="relative ">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        {/* Empty State Card */}
        <div className="bg-[url('/idea.png')] bg-cover bg-no-repeat bg-right rounded-lg min-h-[400px] lg:h-130 shadow-sm border border-[#B6B8B7] p-6 sm:p-12 text-center relative flex flex-col items-center justify-center">
          <h2 className="text-2xl sm:text-[30px] font-semibold text-gray-800 mb-4">
